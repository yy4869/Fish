...
//  Fish
//
//  Created by yaoyuan on 2020/9/14.
//  Copyright © 2020 Tutor. All rights reserved.
//

import UIKit

class SpringInterfaceViewController: UIViewController {

    private lazy var springView: GradientView = {
        let view = GradientView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.topColor = UIColor(rgbValue: 0x64CCF7)
        view.bottomColor = UIColor(rgbValue: 0x359EEC)
        return view
    }()
